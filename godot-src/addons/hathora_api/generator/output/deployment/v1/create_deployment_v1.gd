...
func create_deployment_async(env: Array[Dictionary], rooms_per_process: int, plan_name: String, transport_type: String, container_port: int, build_id: int, additional_container_ports: Array[ContainerPort] = []) -> CreateDeploymentResponse:
...
func create_deployment(env: Array[Dictionary], rooms_per_process: int, plan_name: String, transport_type: String, container_port: int, build_id: int, additional_container_ports: Array[ContainerPort] = []) -> Signal:

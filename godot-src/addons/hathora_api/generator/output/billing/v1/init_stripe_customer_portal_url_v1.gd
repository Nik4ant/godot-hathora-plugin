...
func init_stripe_customer_portal_url_async(return_url: String) -> InitStripeCustomerPortalUrlResponse:
...
func init_stripe_customer_portal_url(return_url: String) -> Signal:

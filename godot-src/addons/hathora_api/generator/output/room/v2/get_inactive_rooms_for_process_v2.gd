...
func get_inactive_rooms_for_process_async(process_id: String) -> GetInactiveRoomsForProcessResponse:
...
func get_inactive_rooms_for_process(process_id: String) -> Signal:

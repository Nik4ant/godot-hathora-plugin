...
func get_logs_for_process_async(process_id: String, tail_lines: int = 0, follow: bool = false) -> GetLogsForProcessResponse:
...
func get_logs_for_process(process_id: String, follow: bool = false, tail_lines: int = 0) -> Signal:
